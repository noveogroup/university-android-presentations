...
fun test() {
    <span class="highlight-current-green fragment" data-fragment-index="1">interval</span>.<span class="highlight-current-green fragment" data-fragment-index="2">subscribe</span>(<span class="highlight-current-green fragment" data-fragment-index="3">object : Observer&lt;Long>() {
        ...
        override fun onNext(tick: Long) { log.debug("tick $tick") }
...
<pre><code class="small" data-trim data-noescape>
    ...
    fun test() {
        interval.subscribe(
                ...
                { },                        // onCompleted
                <span class="fragment highlight-grey" data-fragment-index="1">{ this.disposable = it }</span>           // onSubscribe
        )
    }
...
<pre><code class="small" data-trim data-noescape>
    ...
    fun test() {
        interval.subscribe(
                ...
                { },                         // onCompleted
                <span class="fragment highlight-grey" data-fragment-index="1">{ this.subscription = it }</span>           // onSubscribe
        )
    }
